#!/usr/bin/env python3
"""Run left 90 turn (pulse+settle) while logging IMU gz and integrated progress.
...
Safety: finite max_pulses + timeout, always stop at end.
"""
...
def main() -> int:
    ...
    out_csv = Path("/home/fukuhala/python_ws/dmc_ai_mobility/left90_imu_log.csv")
    out_png = Path("/home/fukuhala/python_ws/dmc_ai_mobility/left90_imu_plot.png")
    ...
    fig.suptitle("Left 90 turn IMU log (gz) + integrated progress")
    fig.tight_layout()
