#!/usr/bin/env python3
"""Run right 360 turn (pulse+settle) while logging IMU gz and integrated progress.
...
def main() -> int:
    ...
    out_csv = Path("/home/fukuhala/python_ws/dmc_ai_mobility/right360_imu_log.csv")
    out_png = Path("/home/fukuhala/python_ws/dmc_ai_mobility/right360_imu_plot.png")
    ...
    fig.suptitle("Right 360 turn IMU log (gz) + integrated progress")
    fig.tight_layout()
